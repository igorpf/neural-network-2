...
class File(object):
    def __init__(self, fileName, normRanges, classes, classProportion, numericalAttributes):
        ...
        self.numericalAttributes = numericalAttributes
...
files = {
	...
	"test": File("../datasets/testdata.txt", 
        [[0,2], [0,2], [0,1], [0,1], None],
        [0.0, 1.0],
        [0.3571, 0.6429],
        [0,0,0,0])
}
